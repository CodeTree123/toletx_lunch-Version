                        ...
                        (i.parentFit = l),
                            e.addEventListener("lazybeforesizes", function (t) {
                                if (
                                    ...
                                    var e = t.target;
                                    t.detail.width = l.calculateSize(
                                        e,
                                        t.detail.width
                                    );
                                }
                ...
                !(function (i, r) {
                    ...
                    function a(t, e) {
                        ...
                        return (
                            (i.srcset = []),
                            e.absUrl &&
                                (m.setAttribute("href", t), (t = m.href)),
                            (t = (
                                (e.prefix || "") +
                                t +
                                (e.postfix || "")
                    ...
                    function o(t) {
                        return (
                            t.getAttribute(
                                t.getAttribute("data-srcattr") || c.srcAttr
                            ) ||
                            ...
                            c = function (r) {
                                if (r.detail.instance == i) {
                                    ...
                                    if (
                                        ...
                                        return void e.removeEventListener(
                                            "lazybeforesizes",
                                            c
                                        );
                                    ("_lazyrias" in s ||
                                        (r.detail.dataAttr && n(s, !0))) &&
        ...
        !(function (r, a) {
            ...
            if (
                ...
                (a.pf = function (e) {
                    var i, a;
                    if (!t.picturefill)
                        for (i = 0, a = e.elements.length; i < a; i++)
                            r(e.elements[i]);
                }),
                    (r = (function () {
                        var n = function (t, e) {
