                        ...
                        <div class="col-8">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/shops/'.$list->photo1)}}" class="my-3" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/shops/'.$list->photo2)}}" class="my-3" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/shops/'.$list->photo3)}}"  class="my-3" alt="" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/shops/'.$list->photo4)}}"  class="my-3" alt="" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/shops/'.$list->photo5)}}"  class="my-3" alt="" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/shops/'.$list->photo6)}}"  class="my-3" width="200" height="200">
                                    @endif
