                        ...
                        <div class="col-8">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/hotels/'.$list->photo1)}}" class="my-3" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/hotels/'.$list->photo2)}}" class="my-3" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/hotels/'.$list->photo3)}}"  class="my-3" alt="" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/hotels/'.$list->photo4)}}"  class="my-3" alt="" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/hotels/'.$list->photo5)}}"  class="my-3" alt="" srcset="" width="200" height="200">
                                    @endif
                                ...
                                <div class="col-4">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/hotels/'.$list->photo6)}}"  class="my-3" width="200" height="200">
                                    @endif
